...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        } else if($cash === 0 or $cash === '') {
            return redirect()->route('order.index')->with('gagal', 'Bayar dulu');
        }
         else {
    ...
    //public function laporan(){
      //  $subTotal = DB::table('order')->get();
        //$pdf = PDF::loadview('order.laporan',[
        //'subTotal'=> $subTotal
    //]);
        //return $pdf->download('order.index')
        //return $pdf->stream();
    //}
}
