            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('catatantransaksi.search') }}" method="post">
                                @csrf

                                {{-- filter nama pegawai <div class="form-group">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a href="{{ route('catatantransaksi.show', $data->id) }}" class="btn btn-primary">View</a></td>
                                            </tr>
                                        @empty
                                            <tr>
