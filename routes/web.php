...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::resource('catatantransaksi',\App\Http\Controllers\CatatanTransaksiController::class);
    Route::post('/catatantransaksi/search', 'App\Http\Controllers\CatatanTransaksiController@search')->name('catatantransaksi.search');
});
...
Route::group(['middleware' => ['auth','levelkasir']], function () {
    ...
    Route::resource('do_transaction', \App\Http\Controllers\DoTransactionController::class);
    Route::resource('invoice',\App\Http\Controllers\InvoiceController::class);
    Route::resource('daftarharga',\App\Http\Controllers\DaftarHargaController::class);
});
